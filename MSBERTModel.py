...
# from SinEmbed import SpectrumNumericalMZTransform,SpectrumNumericalMZCollater
# from SinEmbed import SinusoidalMZEmbedding,PeakEmbedding,SpectrumDataset
...
# mm = Mask(0.2,5)
# ss1,ss2,ss3 = mm(x,intensity_)
# ss1 = ss1.cpu().numpy()
# ss2 = ss2.cpu().numpy()
# ss3 = ss3.cpu().numpy()
# ss4 = [i.cpu().numpy() for i in ss4]
# x = input_id
# x = x.to(device)
# p = 0
# ss = x.cpu().numpy()
# ssp = pos_p.cpu().numpy()
# intens = intensity_.cpu().numpy()
# ss1 = mask_pos.cpu().numpy()
# ssm = sum_intensity.cpu().numpy()
# inp = inten_p.cpu().numpy()
# ina = inten_accum.cpu().numpy()
# inb = inten_bool.cpu().numpy()
